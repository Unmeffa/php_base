...
$formFields =
    [
        ...
        [
            'name' => 'parentId',
            'label' => 'Page Parent',
            'description' => 'Lier la page à',
            'classOptions' => $pages,
        ],
        [
            'name' => 'type',
            'label' => 'Type de page',
            'description' => 'Type de la page',
            'options' => $tPageType
        ],
    ];
?>
...
<div id="modal" class="fixed left-0 top-0 w-full h-full bg-black bg-opacity-50 z-50 flex flex-col">
    <div class="m-auto p-6 bg-white w-full max-w-[380px] max-h-[85vh] relative">
        ...
        <div class="flex flex-col">
            <div class="pb-4">
                <h2 class="text-xl font-bold leading-7 text-gray-900">Créer une page</h2>
            </div>
            <form name="addPage" class="space-y-6 flex flex-col" action="#" method="POST">
